...
from src.domain.models import PostingProposal, ReceiptDoc, Intent
...
class MockBookingService:
    ...
    async def get_booking(self, booking_id: UUID) -> Optional[BookingResponse]:
        """Get mock booking by ID."""
        return self._bookings.get(str(booking_id))
    
    async def get_booking_by_pipeline_run(self, pipeline_run_id: str) -> Optional[BookingResponse]:
